...
- **To send message/query to Center (or the other side) for coordination:** 
  ...
  Or for direct bus append (as center_query to center):

  python3 /data/PCaC-Playgrounds/scripts/pcac_bus.py append --from "Left-Brain" --to "center" --kind "center_query" --text "your message"
