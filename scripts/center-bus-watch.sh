#!/usr/bin/env bash
# Center monitor: live tail of shared/bus/messages.jsonl with center_query highlights
set -euo pipefail
...
echo "center_query (from side 'center:' or main) → needs Center response (pcac_center_reply left|right '...')"
echo "Ctrl-C to exit"
echo "=============================="
