...
echo "For interactive replies (incl /tailor, and now /ask-left /ask-right /ask-both for LMStudio brains):"
...
echo "Also: pcac-ask-both.sh \"question\"   |   pcac-converse.sh left \"topic\" 5"
exec tmux attach -t "$SESSION"
